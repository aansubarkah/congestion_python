...
# 9. repeat #5
# 10. repeat #4
class FpCongestionClassifying(object):
    def __init__(self):
        self.main()
    ...
    def get_raws_unprocessed(self, respondent_id, limitQuery):
        ...
        query = sessionPostgresTraffic.query(Raw).\
            filter(Raw.respondent_id == respondent_id, Raw.processed == False, Raw.t_time.between('2017-07-10 00:00:00', '2017-07-10 23:59:00')).\
